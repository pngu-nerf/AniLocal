...
Anime4K shaders · (maybe) JP-study dual subtitles · **skip-region markers on the playback scrubber** (shaded intro/outro segments from the cached `skip_segments` — additive, separable; lands with the planned player-controls redesign, after skip behavior is correct). Do NOT start these yet.

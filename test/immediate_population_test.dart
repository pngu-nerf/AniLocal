...
void main() {
  group('immediate library population', () {
    late Directory dir;
    ...
    test(
      'offline scan shows anime immediately as named placeholders',
      () async {
    ...
    test(
      ...
      () async {
        ...
        expect(
          ...
          isTrue,
          reason:
              'discovery/placeholder write happens before the AniList lookup',
        );
    ...
    test(
      ...
      () async {
        ...
        expect(
          await db.watchStateFor(synthId, pendingEp.anchoredNumber),
          isNull,
        );

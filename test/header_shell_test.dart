  ...
  group('header shell', () {
    ...
    testWidgets('live state keeps flowing — the scan spinner does not freeze', (
      ...
      await _pumpShell(
        ...
        h.app(
          home: SpecPage(
            spec: HeaderSpec(
              title: 'Library',
              actions: actions(scanning: false),
            ),
          ),
        ),
      );
      ...
      tester
          ...
          .update(
            HeaderSpec(title: 'Library', actions: actions(scanning: true)),
          );
      await tester.pump();
      await tester.pump();
      expect(
    ...
    testWidgets(
      'the header is MOUNTED ONCE — navigation does not re-mount it',
      (tester) async {
        final h = ShellHarness();
        await _pumpShell(
          tester,

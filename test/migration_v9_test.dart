  ...
  group('migration v8 -> v9', () {
    ...
    test(
      ...
      () async {
        ...
        expect(
          files.single.folderPath,
          mount,
          reason: 'owning folder identity',
        );
        expect(
        ...
        expect(
          (ov.fileSize, ov.modifiedAtMs, ov.anchoredEpisode),
          (999, 888, 3),
        );
      ...
      () async {
        ...
        final sync = LibrarySync(
          ...
          matcher: SeriesMatcher(
            providers: [
              AniListMetadataProvider(AniListClient(httpClient: mock)),
            ],
          ),
          cache: db,
